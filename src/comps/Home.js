				...
				>
					...
					<Grid item xl={3} lg={4} md={6} sm={8} xs={12}>
						<Paper
							className={
								fullscreen
									? `${classes.paper} ${classes.fullscreen} ${classes.paper1}`
									: `${classes.paper} ${classes.relative} ${classes.paper1}`
							}
						>
						...
						<Paper className={`${classes.paper} ${classes.paper4}`}>
							...
							<Typography
								...
								dangerouslySetInnerHTML={{
									__html:
										data.currentAnnouncements.find(ann => ann.category === "general")
											?.announcement || "No Announcement Found"
								}}
							/>
						</Paper>
					</Grid>
					...
					<Grid item className={fullscreen && classes.noDisplay} xl={3} lg={4} md={6} sm={8} xs={12}>
						<Paper className={`${classes.paper} ${classes.paper5}`}>
							...
							<Typography
								...
								dangerouslySetInnerHTML={{
									__html:
										data.currentAnnouncements.find(ann => ann.category === "morning")
											?.announcement || "No Announcement Found"
								}}
							/>
						</Paper>

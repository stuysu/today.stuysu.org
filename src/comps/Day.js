		...
		<>
			...
			<div style={{display: "flex", width: "100%"}}>
				<div className={classes.padding}>
					<Typography variant="h1" style={{margin: 0, lineHeight: 1}} align="center">A</Typography>
					<Typography align="center">Regular Bell</Typography>
				</div>
				<div style={{flexGrow: 1}} className={classes.padding}>
					...
					<Typography align="center">World Languages, ELA, Health</Typography>
				</div>
			</div>
		</>
	);
